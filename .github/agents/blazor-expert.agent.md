...
**When operating standalone:** Load the `project-context` skill before any non-trivial change. Pay special attention to `docs/pitfalls/blazor-maui.md` and `docs/pitfalls/dotnet-csharp.md` for domain-specific traps.
