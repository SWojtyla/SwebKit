...
/** Generic JSON view preference (string, number, boolean, or plain object). */
export function loadViewPreference<T extends string | number | boolean | object>(key: string, fallback: T): T {
  try {
...
export function saveViewPreference(key: string, value: string | number | boolean | object): void {
  try {
