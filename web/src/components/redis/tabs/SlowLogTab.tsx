    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
                <span data-testid="redis-slowlog-count">
                    {entries.length} entries
                </span>
                {data.truncated && (
                    <span>(truncated at {data.maxReturned})</span>
                )}
