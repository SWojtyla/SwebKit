...
export function ContextMenu({ x, y, items, onClose }: ContextMenuProps) {
    ...
    useEffect(() => {
        ...
        // Defer the scroll listener by a task: a scroll event already queued when
        // the menu opens (e.g. scrollIntoView bringing the trigger into view)
        // would otherwise dispatch after mount and instantly close the menu.
