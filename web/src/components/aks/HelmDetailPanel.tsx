                    ...
                    <div className="p-4">
                        {historyLoading ? (
                            ...
                            <table
                                ...
                                data-testid="helm-history-table"
                            >
                                <thead>
                ...
                {tab === "notes" && (
                    <div className="p-4">
                        {notesLoading ? (
                            ...
                            <pre
                                className="overflow-auto rounded border bg-card p-3 text-xs font-mono whitespace-pre-wrap"
                                data-testid="helm-notes-content"
                            >
