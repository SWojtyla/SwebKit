...
export function BlobDetailPanel() {
    ...
    return (
        <div
            ...
            data-testid="storage-blob-detail"
        >
            {!ctx.selectedBlob ? (
                <div
                    className="flex h-full items-center justify-center text-muted-foreground"
                    data-testid="storage-no-blob-selected"
                >
                    Select a blob to view details
                </div>
            ) : (
                <div className="p-6 space-y-4">
                    {ctx.blobProps.isLoading && (
                        <div className="text-sm text-muted-foreground">
                            Loading blob properties...
                        </div>
                    )}
                    {ctx.blobProps.error && (
                        <div className="text-sm text-destructive">
                            Error: {ctx.blobProps.error.message}
                        </div>
                    )}
                    {ctx.blobProps.data && (
                        <>
                                ...
                                <>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            data-testid="storage-copy-url-btn"
                                            title="Copy URL (unsigned — may 403/404 on a private container)"
                                        >
                                            {ctx.copiedUrl ? (
                                        ...
                                        <button
                                            onClick={() =>
                                                ctx.handleDownloadBlob(
                                                    ctx.blobProps.data!.name,
                                                )
                                            }
                                            className="text-muted-foreground hover:text-foreground"
                                            data-testid="storage-download-btn"
                                            title="Download blob"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="text-muted-foreground hover:text-foreground"
                                            data-testid="storage-sas-url-btn"
                                            title="Generate SAS URL (signed, expires — works on a private container)"
                                        >
                                    ...
                                    {ctx.showSasUrl && (
                                        <div
                                            ...
                                            data-testid="storage-sas-url-display"
                                        >
                                            <div className="flex items-center gap-2">
                                                <input
                                                    type="text"
                                    ...
                                    <div className="mt-1 flex flex-wrap items-center gap-3 text-sm">
                                        <span
                                            ...
                                            data-testid="storage-blob-size"
                                        >
                                            {formatBytes(
                                                ctx.blobProps.data.sizeBytes,
                                            )}
                                        </span>
                                        <span
                                            className="text-muted-foreground"
                                            data-testid="storage-blob-type"
                                        >
                                            {ctx.blobProps.data.contentType}
                                        </span>
                                        <span
                                            className="text-muted-foreground"
                                            data-testid="storage-blob-modified"
                                        >
                                            {formatDate(
                                                ctx.blobProps.data.lastModified,
                                            )}
                                        </span>
                                    ...
                                    <div>
                                        <div className="mb-2 flex items-center justify-between">
                                            ...
                                            {ctx.metadataEditing ? (
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            ctx.setMetadataEditing(
                                                                false,
                                                            );
                                                            ctx.setMetadataDraft(
                                                                {},
                                                            );
                                                        }}
                                                        className="rounded border px-2 py-1 text-xs"
                                                        data-testid="storage-metadata-cancel"
                                                    >
                                                        Cancel
                                                    </button>
                                                </div>
                                                ...
                                                <button
                                                    ...
                                                    data-testid="storage-metadata-edit-btn"
                                                >
                                        ...
                                        {ctx.metadataEditing ? (
                                            <div
                                                ...
                                                data-testid="storage-metadata-editor"
                                            >
                                                {Object.entries(
                                                    ctx.metadataDraft,
                                                ).map(([k, v]) => (
                                              ...
                                              ctx.blobProps.data.metadata,
                                          ).length > 0 ? (
                                            <div className="rounded-md border overflow-hidden">
                                                <table className="w-full table-fixed text-sm">
                                                    <thead className="bg-muted">
                                                        <tr>
                                                            <th className="w-1/3 px-3 py-2 text-left font-medium">
                                                                Key
                                                            </th>
                            ...
                            {ctx.blobDetailTab === "versions" && (
                                <div data-testid="storage-blob-versions">
                                    {ctx.blobVersions.isLoading && (
                                        <div className="text-sm text-muted-foreground">
                                            Loading versions...
                                        </div>
                                    )}
                                    {ctx.blobVersions.error && (
                                        <div className="text-sm text-destructive">
                                            Error:{" "}
                                            {ctx.blobVersions.error.message}
                                        </div>
                                    )}
                                    {ctx.blobVersions.data && (
                                        <>
                                            <div
                                                ...
                                                data-testid="storage-version-compare-controls"
                                            >
                                                <div className="grid gap-2 md:grid-cols-[1fr_1fr_auto] md:items-end">
                                                    <label className="text-xs">
                                                        ...
                                                        <select
                                                            ...
                                                            onChange={(e) => {
                                                                ctx.setVersionBaseId(
                                                                    e.target
                                                                        .value ||
                                                                        null,
                                                                );
                                                                ctx.setVersionCompareRequested(
                                                                    false,
                                                                );
                                                            }}
                                                    ...
                                                    <label className="text-xs">
                                                        ...
                                                        <select
                                                            value={
                                                                ctx.versionCompareId ??
                                                                ""
                                                            }
                                                            onChange={(e) => {
                                                                ctx.setVersionCompareId(
                                                                    e.target
                                                                        .value ||
                                                                        null,
                                                                );
                                            ...
                                            {ctx.versionComparison.data && (
                                                <div
                                                    ...
                                                    data-testid="storage-version-diff-pane"
                                                >
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-xs text-muted-foreground">
                                                            Added:{" "}
                                                            {ctx.versionComparison.data.metadataDiff.addedKeys.join(
                                                                ", ",
                                                            ) || "none"}{" "}
                                                            · Removed:{" "}
                                                            {ctx.versionComparison.data.metadataDiff.removedKeys.join(
                                                                ", ",
                                                            ) || "none"}{" "}
                                                            · Changed:{" "}
                                                            {ctx.versionComparison.data.metadataDiff.changedKeys.join(
                                                                ", ",
                                                            ) || "none"}
                                                        </div>
                                                    </div>
                                                    {ctx.versionComparison.data
                                                        .contentComparePossible &&
                                                        ctx.versionComparison
                                                            .data.textDiff && (
                                                            <pre
                                                                className="max-h-96 resize-y overflow-y-auto whitespace-pre-wrap break-words rounded bg-muted/40 p-3 text-xs text-foreground"
                                                                data-testid="storage-version-text-diff"
                                                            >
                                                                {
                                                                    ctx
                                                                        .versionComparison
                                            ...
                                            {ctx.versionRestoreId && (
                                                <ConfirmBar
                                                    ...
                                                    onConfirm={
                                                        ctx.handleVersionRestoreConfirm
                                                    }
                                                    onCancel={() =>
                                                        ctx.setVersionRestoreId(
                                                            null,
                            ...
                            {ctx.blobDetailTab === "content" && (
                                <div data-testid="storage-blob-content-tab">
                                    {ctx.blobContent.isLoading && (
                                        <div className="text-sm text-muted-foreground">
                                            Loading content...
                                        </div>
                                    )}
                                    {ctx.blobContent.error && (
                                        <div className="text-sm text-destructive">
                                            Error:{" "}
                                            {ctx.blobContent.error.message}
                                        </div>
                                    )}
                                    {ctx.blobContent.data && (
                                        <div>
                                            {ctx.blobContent.data.isBinary ? (
                                                <div
                                                    ...
                                                    data-testid="storage-blob-binary"
                                                >
                                                    Binary content (
                                                    {formatBytes(
                                                        ctx.blobContent.data
                                                ...
                                                <>
                                                    ...
                                                    <pre
                                                        className="body-viewer min-h-[30rem] max-h-[80vh] resize-y overflow-auto whitespace-pre-wrap break-words rounded-md border bg-card p-4 font-mono text-sm text-foreground"
                        ...
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        ctx.setCopyDestBlob(e.target.value)
                                    }
                            ...
                            <label className="flex items-start gap-2 text-xs">
                                <input
                                    ...
                                    onChange={(e) => {
                                        ctx.setCopyOverwrite(e.target.checked);
                                ...
                                <span>
                                    ...
                                    <span className="text-muted-foreground">
                                        Only enable this when replacing an
                                        existing destination is intentional.
                                    </span>
                                </span>
                            </label>
                            {ctx.copyStatus && (
                                <p
                                    ...
                                    data-testid="storage-copy-status"
                                >
                                    {ctx.copyStatus}
                                </p>
                            )}
