...
/**
 * Small, unobtrusive context-window usage indicator (workspace-intelligence Module 6) — an
 ...
 */
export function ContextUsageIndicator({ percent }: ContextUsageIndicatorProps) {
  if (percent <= 0) return null;

  const isGettingFull = percent >= 75;
