...
- Maintain clear backlinks to active feature planning and technical task tracking.

## Test Levels

- Unit tests (`tests/SwebKit.Core.Tests/`, `tests/SwebKit.Azure.Tests/`): message models, mapping, and operation guards.
- Component tests (`tests/SwebKit.App.Tests/`): DLQ views, composer, template UX, filters, and confirmations.
- Integration tests (service-mocked): send, peek, resubmit, and complete pipelines with expected sequencing.
