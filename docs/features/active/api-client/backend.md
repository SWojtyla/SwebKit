...
- singleton workflow services: `ApiClientWorkflowService`
...
The post-Phase-10 backend roadmap is implemented except for retired active collection running. Future backend work should start from a new feature plan, especially for custom flows, assertions, cookie handling, PR creation, or hosted collaboration.
