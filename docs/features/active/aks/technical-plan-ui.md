...
```
AksPage (Pages/)
â”œâ”€â”€ WorkloadOverview (Aks/)
â”œâ”€â”€ PodLogView (Aks/)        â€” buffered streaming, multi-pod
â”œâ”€â”€ PortForwardPanel (Aks/)  â€” active tunnels list
â”œâ”€â”€ TerminalView (Aks/)      â€” xterm.js via JS interop
â””â”€â”€ EventsTimeline (Aks/)
```
...
8. Implement AKS â†’ Observability cross-link navigation.
