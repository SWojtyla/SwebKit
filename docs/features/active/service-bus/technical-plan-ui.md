---
title: "Technical Plan â€” Service Bus: UI"
owner: ""
status: "In Progress"
created: "2026-03-08"
updated: ""
...
# Technical Plan â€” Service Bus: UI
...
â”œâ”€â”€ namespace panel
â”‚   â””â”€â”€ EntityTree (ServiceBus/)
â”‚       â”œâ”€â”€ LoadingSpinner (Shared/)
â”‚       â””â”€â”€ ErrorCallout (Shared/)
â””â”€â”€ tab area
    â”œâ”€â”€ DlqView (ServiceBus/)
    â”œâ”€â”€ MessageListView (ServiceBus/)
    â”‚   â””â”€â”€ PropRow (ServiceBus/)
    â””â”€â”€ MessageDetailPane (ServiceBus/)
        â””â”€â”€ PropRow (ServiceBus/)
```
...
- [x] Build `MessageComposer.razor` with body editor and property key/value table.
  ...
  - Done: inline panel in MessageListView filter bar (âœ‰ Send toggle).
...
See `technical-plan-ui-polish.md` for the full plan covering:

- Grid layout fix (headers clipped, resize handles misaligned)
- Button label clarity ("Copy JSON" â†’ "Copy Full Message")
...
- `technical-plan-ui-bugfixes.md`
- `technical-plan-ui-polish.md`
- `technical-plan-backend.md`
- `test-plan.md`
