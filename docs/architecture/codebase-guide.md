...
| SQL Server/Azure SQL browsing, queries, compare, and discovery             | `src/SwebKit.Core/Abstractions/ISqlClient.cs`, `src/SwebKit.Sql/`, and `src-sidecar/Endpoints/SqlEndpoints.cs`                                                                                                       |
...
| API Client UI, collections, environments, Git panel                        | `web/src/components/api-client/ApiClientPage.tsx`, `web/src/components/api-client/CollectionTree.tsx`, `web/src/components/api-client/GitPanel.tsx`, and `src-tauri/src/git.rs`                                      |
| API Client domain, persistence, variables, export/import                   | `web/src/lib/types.ts`, `src/SwebKit.Core/Domain/ApiClientModels.cs`, `src/SwebKit.Core/Configuration/CollectionRepository.cs`, `src/SwebKit.Core/Services/VariableSubstitutionService.cs`                           |
...
│
├── SwebKit.Sql/                  # SQL Server/Azure SQL client, ScriptDom write-guard, discovery
│
...
| `Azure*Client` / `Kubernetes*Client` / `RedisClient` / `DevOpsClient` / `Sql*Client` | Concrete SDK or HTTP implementation of an abstraction.                                                            |
...
| API Client                     | `web/src/components/api-client/` (`ApiClientPage.tsx`, `RequestEditor.tsx`, `ResponseViewer.tsx`, `ResponseBodyViewer.tsx`, `GitPanel.tsx`, `method-badge.tsx`), `web/src/lib/` (`codemirror-theme.ts`, `response-body.ts`, `git-remote.ts`), `src-tauri/src/git.rs`, `src-sidecar/Endpoints/ApiClientEndpoints.cs`, `src/SwebKit.Core/Services/HttpRequestExecutor.cs`                                                                                                                                                                                                                                                                                                             |
| Workspace map (Settings → Map) | `web/src/components/settings/` (`WorkspaceMapSettings.tsx`, `WorkspaceMapInspector.tsx`, `WorkspaceMapAddPicker.tsx`, `workspace-map-utils.ts`), `web/src/components/shared/TopologyGraph.tsx`, `web/src/lib/theme-colors.ts`, `src-sidecar/Endpoints/WorkspaceTopologyEndpoints.cs`, `src-sidecar/Services/WorkspaceRelationshipSuggestionService.cs`, `src-sidecar/Services/AgentSystemPromptBuilder.cs` (per-turn `## Workspace map` prompt section), `src/SwebKit.Core/Domain/WorkspaceTopology.cs` (`WorkspaceMap`, `WorkspaceMapLookup`), `src/SwebKit.Agents/Tools/InvestigateWorkspaceIssueTool.cs`, `src/SwebKit.Agents/Tools/AksToolContext.cs` (per-context AKS clients) |
| SQL Database Explorer          | `web/src/components/sql/` (`SqlPage.tsx`, `SqlEditor.tsx`, `SchemaTree.tsx`, `ResultsGrid.tsx`, `BrowsePanel.tsx`, `SavedQueriesPanel.tsx`, `ComparePanel.tsx`), `web/src/components/settings/SqlSettings.tsx`, `web/src/lib/hooks/useSql.ts`, `src-sidecar/Endpoints/SqlEndpoints.cs`, `src/SwebKit.Sql/`, `src/SwebKit.Core/Abstractions/ISqlClient.cs`, `src/SwebKit.Core/Services/DemoSqlClient.cs`, `src/SwebKit.Agents/Tools/Sql/`                                                                                                                                                                                                                                            |
