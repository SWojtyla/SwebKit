...
| Settings and configuration | `src/SwebKit.App/Components/Pages/SettingsPage.razor`, `src/SwebKit.WinUI/Views/Settings/SettingsPage.xaml`, `src/SwebKit.App/Components/Pages/*ConfigForm.razor`, `src/SwebKit.WinUI/Services/ConfigurationProbeService.cs`, `src/SwebKit.Core/Configuration/ProfileRepository.cs`, `src/SwebKit.Core/Configuration/AppDataPaths.cs`                                                                                          |
