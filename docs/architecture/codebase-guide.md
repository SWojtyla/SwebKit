...
| Service Bus behavior, queue/DLQ operations, or native workspace state      | `src/SwebKit.Core/Abstractions/IServiceBusClient.cs`, `src/SwebKit.Azure/ServiceBus/AzureServiceBusClient.cs`, `src/SwebKit.WinUI/ViewModels/ServiceBus/ServiceBusPageViewModel.cs`, `src/SwebKit.WinUI/Views/ServiceBus/ServiceBusPage.xaml.cs`, `src/SwebKit.Core/Configuration/UiStateRepository.cs`, and `src/SwebKit.Core/Configuration/ScheduledMessageRepository.cs` |
...
│   └── Storage/
│
├── SwebKit.WinUI/                # Native WinUI shell, pages, view models, and controls
│   ├── Views/                    # Page XAML and code-behind for native workspaces
│   ├── ViewModels/               # Page and shell state for the native UI
│   ├── Controls/                 # Shared shell, cards, lists, and detail-pane primitives
│   └── Services/                 # Native-only coordinators and probes
│
...
| Service Bus                | `src/SwebKit.App/Components/Pages/ServiceBusPage.razor`, `src/SwebKit.App/Components/ServiceBus/MessageListView.razor`, `src/SwebKit.App/Components/ServiceBus/DlqView.razor`, `src/SwebKit.WinUI/Views/ServiceBus/ServiceBusPage.xaml`, `src/SwebKit.WinUI/Views/ServiceBus/ServiceBusPage.xaml.cs`, `src/SwebKit.WinUI/ViewModels/ServiceBus/ServiceBusPageViewModel.cs`, `src/SwebKit.Core/Configuration/UiStateRepository.cs`, `src/SwebKit.Core/Configuration/ScheduledMessageRepository.cs`, `src/SwebKit.Azure/ServiceBus/AzureServiceBusClient.cs` |
