...
| Settings, configuration health, profile persistence, bundle import/export, appearance, workspace topology map | `functionalities/settings-and-configuration.md`, `functionalities/agent.md` (map → prompt injection), `design.md` Settings Save and Config Propagation Flow  | `docs/pitfalls/dotnet-csharp.md`, `docs/pitfalls/azure-sdk.md`, `docs/pitfalls/react-frontend.md` | Verify atomic persistence, backup recovery, credential references, and readiness checks.            |
