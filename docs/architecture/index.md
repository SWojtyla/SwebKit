...
| Agent chat, tools, ACP host, MCP bridge, proactive insights                      | `functionalities/agent.md`, `ai-and-mcp.md`, `design.md` Agent Chat Flow               | `docs/pitfalls/agent-workflow.md`                                    | Tool tests in `SwebKit.Agents.Tests`; ACP session tests in Sidecar tests.                   |
