...
/// plumbing the LLM client needs:
/// <list type="bullet">
///   <item><see cref="GetDefinitions"/> – the JSON schema descriptors the model uses to decide which tool to call.</item>
...
public interface IAgentToolRegistry
{
    ...
    /// <summary>Dispatches a tool call from the model to the correct <see cref="IAgentTool"/>.</summary>
    ...
    /// <returns>A string result that will be sent back to the model as the tool message.</returns>
